...
export EXPERIMENT_NAME="curriculum_start_at_15percent"
...
echo "Copying starting checkpoint"
BASELINE_DIR="/ceph/scratch/martorellat/guided_diffusion/curriculum/blobs_FINAL_curriculum_baseline_every_5000"
...
echo "Copied starting checkpoint - DONE"
