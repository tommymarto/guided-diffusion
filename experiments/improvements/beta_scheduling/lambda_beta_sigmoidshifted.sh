...
export EXPERIMENT_NAME="AAAdistributional_lambda_beta_sigmoidshifted"
...
if [ "$LOCAL_MODE" = true ]; then
    ...
    python -m debugpy --listen 0.0.0.0:5678 --wait-for-client ./scripts/image_train.py \
        ...
        --distributional_lambda_weighting sigmoid_shifted \
        --distributional_beta_schedule sigmoid_shifted \
