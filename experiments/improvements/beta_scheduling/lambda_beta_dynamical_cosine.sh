...
export EXPERIMENT_NAME="AAAFINAL_distributional_lambda_beta_dynamical_cosine"
...
if [ "$LOCAL_MODE" = true ]; then
    ...
    python -m debugpy --listen 0.0.0.0:5678 --wait-for-client ./scripts/image_train.py \
        ...
        --distributional_lambda_weighting dynamical_cosine \
        --distributional_beta_schedule dynamical_cosine \
