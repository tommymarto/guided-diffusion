...
export EXPERIMENT_NAME="distributional_lambda_inverted_schedule_dynamical_sigmoid_shifted"
...
if [ "$LOCAL_MODE" = true ]; then
    ...
    python -m debugpy --listen 0.0.0.0:5678 --wait-for-client ./scripts/image_train.py \
        ...
        --distributional_lambda_weighting dynamical_sigmoid_shifted_true \
