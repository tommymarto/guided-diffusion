...
export EXPERIMENT_NAME="cifar10_cond_distributional_logsnrinverted_without_sigma_better_channels"
...
if [ "$LOCAL_MODE" = true ]; then
    ...
    python -m debugpy --listen 0.0.0.0:5678 --wait-for-client ./scripts/image_train.py \
        ...
        --distributional_loss_weighting KINGMA_SNR_INVERTED \
